...
https://bulk.openweathermap.org/snapshot/hourly1h_14.json.gz?appid=553d2e3eac0ee6087d8ddc9e2183a404
...
window.onload = function() {
    ...
    function createDuck() {
        ...
        function moveDuck(duck) {
            ...
            let rowD = Math.abs(row - left);
            let colD = Math.abs(col - top);
            let distance = Math.sqrt(rowD ** 2 + colD ** 2);
